...
def main():
    ...
    # Pass given cleartext block to the TEA_Cipher encrypt function and store the output.
    ciphertext = test.encrypt(cleartext)

    # ciphertext should decipher to target_cleartext = [0x30E65089, 0x80EC2E88]
